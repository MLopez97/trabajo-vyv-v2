...
/** Implementa la interfaz de la abstraccion utilizando (delegando a) una referencia a un objeto de
 *  tipo implementor  */
public class SendAbstractionImpl implements SendAbstraction {
	 ...
	 * @param sourceActiviy actividad desd la cual se abrira la actividad encargada d enviar la nota
...
//       	    implementor = new MailImplementor(sourceActivity);
	...
	/** Envia la correo con el asunto (subject) y cuerpo (body) que se reciben como parametros a
	 *  traves de un objeto delegado
